...
void merge1(vector<int> &arr, int left, int mid, int right){
 ...
 void merge3(vector<int> &arr, int left, int mid, int right){
    vector<int> temp(right - left+1);
    int i = left;
    int j = mid +1;
    int k = 0;
 ...
 void merge4(vector<int> &arr, int left, int mid, int right){
    vector<int> temp(right - left+1);
    int i = left;
    int j = mid+1;
    int k = 0;
 ...
 void mergesort4(vector<int> &arr, int left, int right){
    if(left>=right) return;
    int mid = (left + (right-left)/2);
 ...
 void merge5(vector<int> &arr, int left, int mid, int right){
    vector<int> temp(right- left+1);
    int i = left;
    int j = mid + 1;
    int k = 0;
